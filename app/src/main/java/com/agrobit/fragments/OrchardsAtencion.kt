 ...
 * [OrchardsAtencion.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [OrchardsAtencion.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class OrchardsAtencion : Fragment() {
    ...
    override fun onCreateView(
        ...
        vista= inflater.inflate(R.layout.fragment_orchards_atencion, container, false)


        val orchardRecyclerView: RecyclerView =vista.findViewById(R.id.atencionor_rv)
        ...
        itemList.add(0,Item(1, Header("Requieren atención",itemList.size)))
    ...
    companion object {
         ...
         * @return A new instance of fragment OrchardsAtencion.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OrchardsAtencion().apply {
